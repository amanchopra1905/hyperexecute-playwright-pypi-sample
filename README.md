...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=PyTest&frameworkType=PlayWright)
---
...
# How to run Playwright automation tests on HyperExecute (using PyTest framework) — TestMu AI (Formerly LambdaTest)
...
#### Execute PyTest tests using Autosplit mechanism on Mac platform
...
#### Execute PyTest tests using Matrix mechanism on Mac platform
