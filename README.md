# Run Playwright PyTest Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Playwright Python PyTest tests using HyperExecute. This sample shows how to configure Playwright + PyTest + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-playwright-pypi-sample && cd hyperexecute-playwright-pypi-sample
